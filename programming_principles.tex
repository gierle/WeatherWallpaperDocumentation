...
\begin{listing}[h]
\inputminted[linenos=true,frame=lines, breaklines, breakbytokenanywhere]{csharp}{Listings/ValidateInputsPre.cs}
...
\\
\begin{listing}[htb]
	\inputminted[linenos=true,frame=lines, breaklines, breakbytokenanywhere]{csharp}{Listings/ImageHandler_old.cs}
...
\\
\begin{listing}[htb]
	\inputminted[linenos=true,frame=lines, breaklines, breakbytokenanywhere]{csharp}{Listings/ImageHandler_new.cs}
